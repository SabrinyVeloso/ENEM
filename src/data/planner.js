  ...
  math: [
    {
      ...
      importance: 5,
      frequency: "Muito alta",
      description: "Cálculo rápido, desconto, acréscimo e variação percentual.",
    },
    {
      title: "Regra de três",
      priority: "hot",
      ...
      frequency: "Muito alta",
      description:
        "Proporcionalidade direta e inversa em problemas do cotidiano.",
    },
    {
      ...
      frequency: "Muito alta",
      description:
        "Comparação entre grandezas e leitura de relações matemáticas.",
    },
    {
      ...
      frequency: "Muito alta",
      description:
        "Interpretação de eixos, tendências e comparação de dados visuais.",
    },
    {
      title: "Interpretação de tabelas",
      priority: "hot",
      difficulty: "Fácil",
      importance: 5,
      frequency: "Muito alta",
      description:
        "Extração de informação direta e comparação entre linhas e colunas.",
    },
    {
      ...
      frequency: "Muito alta",
      description:
        "Leitura crítica de gráficos de barras, linhas, setores e funções.",
    },
    {
      ...
      frequency: "Alta",
      description:
        "Planejamento financeiro, preço, parcelas e decisões de consumo.",
    },
    {
      title: "Juros simples",
      priority: "hot",
      ...
      importance: 5,
      frequency: "Alta",
      description: "Cálculo de rendimento e dívidas com taxa linear no tempo.",
    },
    {
      ...
      frequency: "Alta",
      description:
        "Crescimento exponencial aplicado a investimentos e empréstimos.",
    },
    {
      ...
      importance: 5,
      frequency: "Alta",
      description: "Áreas, perímetros, polígonos, círculo e relações métricas.",
    },
    {
      ...
      importance: 5,
      frequency: "Alta",
      description: "Volumes, prismas, cilindros, cones e pirâmides.",
    },
    {
      title: "Escala",
      priority: "frequent",
      ...
      frequency: "Alta",
      description:
        "Mapas, plantas, redução e ampliação em representações proporcionais.",
    },
    {
      ...
      frequency: "Alta",
      description:
        "Crescimento linear, raiz da função e interpretação do gráfico.",
    },
    {
      ...
      importance: 4,
      frequency: "Alta",
      description: "Parábola, vértice, raízes e leitura de comportamento.",
    },
    {
      title: "Trigonometria",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Média",
      description: "Seno, cosseno, tangente e aplicação em triângulos.",
    },
    {
      ...
      importance: 4,
      frequency: "Média",
      description: "Periodicidade, leitura de curvas e fenômenos oscilatórios.",
    },
    {
      ...
      importance: 4,
      frequency: "Média",
      description: "Crescimento, decaimento e modelagem exponencial.",
    },
    {
      title: "Logaritmos",
      priority: "hard",
      ...
      importance: 4,
      frequency: "Média",
      description: "Propriedades logarítmicas e resolução de equações.",
    },
    {
      ...
      importance: 3,
      frequency: "Média",
      description: "Sequência linear, termo geral e soma de termos.",
    },
    {
      ...
      importance: 3,
      frequency: "Média",
      description: "Sequência multiplicativa, termo geral e soma finita.",
    },
    {
      title: "Estatística",
      priority: "hot",
      ...
      frequency: "Alta",
      description:
        "Média, dispersão e leitura de dados para análise de contexto.",
    },
    {
      ...
      importance: 5,
      frequency: "Alta",
      description: "Medidas de tendência central cobradas com frequência.",
    },
    {
      title: "Probabilidade",
      priority: "hot",
      ...
      importance: 5,
      frequency: "Alta",
      description: "Espaço amostral, evento e chance em situações variadas.",
    },
    {
      ...
      frequency: "Média",
      description:
        "Princípio fundamental da contagem, arranjo, combinação e permutação.",
    },
    {
      title: "Conjuntos",
      priority: "medium",
      ...
      importance: 3,
      frequency: "Média",
      description: "Operações com conjuntos, união, interseção e diagramas.",
    },
    {
      ...
      frequency: "Média",
      description:
        "Plano cartesiano, distância, ponto médio e equação da reta.",
    },
    {
      title: "Razão entre grandezas",
      priority: "hot",
      difficulty: "Fácil",
      importance: 5,
      frequency: "Alta",
      description:
        "Comparação de medidas em contexto prático e interdisciplinar.",
    },
  ],
  language: [
    {
      ...
      importance: 5,
      frequency: "Muito alta",
      description: "Leitura literal, inferência, intenção e ideia central.",
    },
    {
      title: "Linguagem verbal e não verbal",
      priority: "hot",
      difficulty: "Fácil",
      importance: 5,
      frequency: "Alta",
      description:
        "Relação entre imagem, texto e sentido construído pelo conjunto.",
    },
    {
      ...
      importance: 5,
      frequency: "Alta",
      description: "Crônica, reportagem, artigo, tirinha, propaganda e carta.",
    },
    {
      title: "Interpretação de propaganda",
      priority: "hot",
      difficulty: "Fácil",
      importance: 5,
      frequency: "Alta",
      description: "Recursos persuasivos, apelo visual e linguagem de consumo.",
    },
    {
      title: "Análise de tirinhas",
      priority: "hot",
      difficulty: "Fácil",
      importance: 5,
      frequency: "Alta",
      description: "Humor, ironia, crítica social e relação entre quadros.",
    },
    {
      title: "Análise de memes",
      priority: "frequent",
      difficulty: "Fácil",
      importance: 4,
      frequency: "Alta",
      description: "Contexto, ironia, cultura digital e leitura rápida.",
    },
    {
      ...
      importance: 4,
      frequency: "Média",
      description: "Letra, tema, figura de linguagem e crítica social.",
    },
    {
      ...
      importance: 4,
      frequency: "Alta",
      description: "Referencial, emotiva, conativa, poética e fática.",
    },
    {
      ...
      importance: 4,
      frequency: "Alta",
      description: "Metáfora, metonímia, ironia, hipérbole, antítese e outras.",
    },
    {
      ...
      frequency: "Alta",
      description:
        "Conectivos, substituição lexical e encadeamento das ideias.",
    },
    {
      title: "Semântica",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Sentido das palavras, contexto e efeitos de significado.",
    },
    {
      ...
      importance: 4,
      frequency: "Alta",
      description: "Sentido literal e figurado aplicado em textos variados.",
    },
    {
      ...
      importance: 4,
      frequency: "Alta",
      description: "Diálogo entre textos, referências e recriação de sentidos.",
    },
    {
      title: "Argumentação",
      priority: "hot",
      ...
      importance: 5,
      frequency: "Alta",
      description: "Tese, repertório, argumento e contra-argumento.",
    },
    {
      ...
      importance: 4,
      frequency: "Alta",
      description: "Narrativo, descritivo, dissertativo e injuntivo.",
    },
    {
      ...
      importance: 3,
      frequency: "Média",
      description: "Registros, variantes regionais, sociais e históricas.",
    },
    {
      ...
      importance: 3,
      frequency: "Média",
      description: "Regras de grafia, acento e uso correto da língua padrão.",
    },
    {
      ...
      importance: 3,
      frequency: "Média",
      description: "Relação entre verbo e sujeito em diferentes construções.",
    },
    {
      ...
      importance: 3,
      frequency: "Média",
      description: "Ajuste entre substantivo, adjetivo, artigo e numeral.",
    },
    {
      ...
      importance: 4,
      frequency: "Média",
      description: "Vínculo entre verbo e complemento com preposição adequada.",
    },
    {
      title: "Crase",
      priority: "hard",
      ...
      importance: 4,
      frequency: "Média",
      description: "Uso do acento grave em fusão de preposição com artigo.",
    },
    {
      ...
      frequency: "Alta",
      description:
        "Autores, escolas literárias e leitura histórica da literatura.",
    },
    {
      title: "Modernismo",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Primeira, segunda e terceira fases com contexto histórico.",
    },
    {
      ...
      importance: 3,
      frequency: "Média",
      description: "Barroco, Arcadismo, Romantismo, Realismo e demais escolas.",
    },
    {
      title: "Artes",
      priority: "medium",
      ...
      importance: 3,
      frequency: "Média",
      description: "Leitura de obra, contexto cultural e linguagem artística.",
    },
  ],
  humanas: [
    {
      ...
      importance: 5,
      frequency: "Muito alta",
      description: "Relações internacionais, blocos, disputas e território.",
    },
    {
      title: "Globalização",
      priority: "hot",
      ...
      importance: 5,
      frequency: "Muito alta",
      description: "Fluxos, redes, economia mundial e desigualdades.",
    },
    {
      title: "Atualidades",
      priority: "hot",
      ...
      frequency: "Muito alta",
      description:
        "Temas contemporâneos com leitura crítica e contextualizada.",
    },
    {
      ...
      frequency: "Alta",
      description:
        "Coronelismo, café com leite, movimentos sociais e política.",
    },
    {
      title: "Era Vargas",
      priority: "hot",
      ...
      frequency: "Alta",
      description:
        "Estado Novo, industrialização, trabalhismo e centralização.",
    },
    {
      ...
      frequency: "Alta",
      description:
        "Regime autoritário, repressão, resistência e redemocratização.",
    },
    {
      title: "Cidadania",
      priority: "hot",
      ...
      importance: 5,
      frequency: "Alta",
      description: "Direitos, participação social, democracia e vida coletiva.",
    },
    {
      ...
      frequency: "Alta",
      description:
        "Guerras, tensões políticas e efeitos humanitários contemporâneos.",
    },
    {
      title: "Guerra Fria",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Bipolaridade, corrida armamentista e influência global.",
    },
    {
      ...
      importance: 4,
      frequency: "Alta",
      description: "Transformações produtivas, trabalho e urbanização.",
    },
    {
      title: "Urbanização",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Crescimento urbano, segregação e infraestrutura.",
    },
    {
      title: "Demografia",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Pirâmide etária, natalidade, mortalidade e migrações.",
    },
    {
      title: "Cartografia",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Mapas, coordenadas, projeções e leitura espacial.",
    },
    {
      title: "Meio ambiente",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Sustentabilidade, impactos ambientais e preservação.",
    },
    {
      ...
      importance: 4,
      frequency: "Alta",
      description: "Produção, indústria, energia e cadeias globais.",
    },
    {
      title: "Clima",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Massas de ar, fenômenos climáticos e relevo atmosférico.",
    },
    {
      title: "Agropecuária",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Campo brasileiro, produção, mecanização e território.",
    },
    {
      title: "Migrações",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Fluxos migratórios internos e externos, causas e efeitos.",
    },
    {
      title: "Feudalismo",
      priority: "medium",
      ...
      importance: 3,
      frequency: "Média",
      description: "Sociedade medieval, relações de poder e economia agrária.",
    },
    {
      title: "Absolutismo",
      priority: "medium",
      ...
      importance: 3,
      frequency: "Média",
      description: "Centralização do poder monárquico e contexto europeu.",
    },
    {
      title: "Iluminismo",
      priority: "medium",
      ...
      importance: 3,
      frequency: "Média",
      description: "Razão, ciência, crítica ao absolutismo e direitos.",
    },
    {
      ...
      importance: 3,
      frequency: "Média",
      description: "Mudanças políticas, sociais e ideológicas na França.",
    },
    {
      ...
      importance: 4,
      frequency: "Alta",
      description: "Maquinização, urbanização e transformação do trabalho.",
    },
    {
      title: "Imperialismo",
      priority: "medium",
      ...
      importance: 3,
      frequency: "Média",
      description: "Expansão europeia, dominação e disputa por territórios.",
    },
    {
      ...
      importance: 3,
      frequency: "Média",
      description: "Crises europeias, alianças e consequências globais.",
    },
    {
      ...
      importance: 3,
      frequency: "Média",
      description: "Totalitarismos, conflito global e reorganização do mundo.",
    },
    {
      ...
      frequency: "Média",
      description:
        "Socrates, Platão, Aristóteles e bases do pensamento filosófico.",
    },
    {
      ...
      importance: 3,
      frequency: "Média",
      description: "Racionalismo, empirismo, contratualismo e crítica moderna.",
    },
    {
      ...
      importance: 3,
      frequency: "Média",
      description: "Durkheim, Marx, Weber e análise social da modernidade.",
    },
  ],
  nature: [
    {
      ...
      frequency: "Muito alta",
      description:
        "Relações ecológicas, cadeias, biomas e equilíbrio ambiental.",
    },
    {
      ...
      frequency: "Alta",
      description:
        "Fluxo de energia, produtores, consumidores e decompositores.",
    },
    {
      title: "Citologia",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Organelas, membrana, metabolismo e funções celulares.",
    },
    {
      title: "Genética",
      priority: "hot",
      ...
      importance: 5,
      frequency: "Muito alta",
      description: "Herança, DNA, RNA, dominância e problemas clássicos.",
    },
    {
      title: "Evolução",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Seleção natural, adaptação e teoria evolutiva.",
    },
    {
      title: "Biotecnologia",
      priority: "medium",
      ...
      importance: 4,
      frequency: "Média",
      description: "Transgênicos, clonagem, PCR e aplicações tecnológicas.",
    },
    {
      ...
      importance: 5,
      frequency: "Alta",
      description: "Sistemas do corpo humano e seus funcionamentos integrados.",
    },
    {
      ...
      importance: 4,
      frequency: "Média",
      description: "Transporte, fotossíntese, hormônios e crescimento vegetal.",
    },
    {
      ...
      importance: 4,
      frequency: "Alta",
      description: "Doenças, prevenção, estrutura e relações com o ser humano.",
    },
    {
      title: "Imunologia",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Defesa do corpo, vacinas, anticorpos e imunidade.",
    },
    {
      ...
      importance: 4,
      frequency: "Alta",
      description: "Sistema reprodutor, ciclo menstrual, fecundação e saúde.",
    },
    {
      title: "Bioquímica",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Carboidratos, lipídios, proteínas, enzimas e energia.",
    },
    {
      ...
      frequency: "Alta",
      description:
        "Consumo consciente, reciclagem, recursos e futuro ambiental.",
    },
    {
      ...
      frequency: "Alta",
      description:
        "Funções orgânicas, hidrocarbonetos e aplicações do cotidiano.",
    },
    {
      title: "Eletroquímica",
      priority: "hot",
      ...
      importance: 5,
      frequency: "Alta",
      description: "Pilha, eletrólise, oxirredução e energia química.",
    },
    {
      title: "Termoquímica",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Reações endotérmicas, exotérmicas e variação de energia.",
    },
    {
      ...
      importance: 5,
      frequency: "Alta",
      description: "Tipos de reação, balanceamento e leitura de equações.",
    },
    {
      ...
      frequency: "Alta",
      description:
        "Propriedades periódicas, grupos, períodos e tendência química.",
    },
    {
      ...
      importance: 4,
      frequency: "Alta",
      description: "Iônica, covalente e metálica, polaridade e estrutura.",
    },
    {
      title: "Soluções",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Concentração, diluição, solubilidade e preparo.",
    },
    {
      title: "pH",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Acidez, basicidade e escala de pH em situações reais.",
    },
    {
      ...
      importance: 5,
      frequency: "Alta",
      description: "Filtração, destilação, centrifugação, decantação e mais.",
    },
    {
      ...
      importance: 4,
      frequency: "Alta",
      description: "Relação molar, cálculo químico e rendimento de reação.",
    },
    {
      ...
      importance: 5,
      frequency: "Alta",
      description: "Poluição, tratamento, efeito estufa e impacto ambiental.",
    },
    {
      title: "Termologia",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Calor, temperatura, dilatação e equilíbrio térmico.",
    },
    {
      title: "Ondulatória",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Som, luz, frequência, amplitude e fenômenos ondulatórios.",
    },
    {
      title: "Óptica",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Espelhos, lentes, refração e formação de imagens.",
    },
    {
      title: "Hidrostática",
      priority: "medium",
      ...
      importance: 3,
      frequency: "Média",
      description: "Pressão, empuxo, densidade e fluidos em equilíbrio.",
    },
    {
      title: "Cinemática",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Velocidade, aceleração, gráficos e leitura de movimento.",
    },
    {
      title: "Dinâmica",
      priority: "frequent",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Forças, interações e análise de movimentos.",
    },
    {
      ...
      importance: 5,
      frequency: "Alta",
      description: "Inércia, força resultante e ação e reação.",
    },
    {
      ...
      importance: 5,
      frequency: "Alta",
      description: "Potência, energia mecânica e conservação.",
    },
    {
      title: "Eletricidade",
      priority: "hot",
      ...
      importance: 5,
      frequency: "Alta",
      description: "Corrente, tensão, potência e consumo de energia.",
    },
    {
      ...
      frequency: "Alta",
      description:
        "Associação de resistores, leitura de esquemas e aplicações.",
    },
    {
      title: "Energia e potência",
      priority: "hot",
      difficulty: "Média",
      importance: 5,
      frequency: "Alta",
      description: "Uso de energia em eletrodomésticos, máquinas e sistemas.",
    },
  ],
  essay: [
    {
      ...
      importance: 5,
      frequency: "Alta",
      description: "Abertura objetiva com contextualização e tese.",
    },
    {
      title: "Tese",
      priority: "hot",
      ...
      importance: 5,
      frequency: "Alta",
      description: "Posicionamento claro que guia todo o texto.",
    },
    {
      title: "Desenvolvimento I",
      priority: "hot",
      difficulty: "Média",
      importance: 5,
      frequency: "Alta",
      description: "Primeiro argumento com repertório e explicação.",
    },
    {
      title: "Desenvolvimento II",
      priority: "hot",
      difficulty: "Média",
      importance: 5,
      frequency: "Alta",
      description: "Segundo argumento articulado com progressão lógica.",
    },
    {
      title: "Coesão",
      priority: "hot",
      ...
      importance: 5,
      frequency: "Alta",
      description: "Conectivos, substituições e encadeamento textual.",
    },
    {
      title: "Coerência",
      priority: "hot",
      ...
      importance: 5,
      frequency: "Alta",
      description: "Manutenção do sentido, lógica e consistência entre ideias.",
    },
    {
      ...
      importance: 5,
      frequency: "Alta",
      description: "Referências legítimas e produtivas para a argumentação.",
    },
    {
      ...
      frequency: "Alta",
      description:
        "Eixo central de temas do ENEM e da proposta de intervenção.",
    },
    {
      ...
      importance: 5,
      frequency: "Alta",
      description: "Agente, ação, meio, finalidade e detalhamento.",
    },
    {
      title: "Competência 1",
      priority: "medium",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Norma culta, ortografia e estrutura linguística.",
    },
    {
      title: "Competência 2",
      priority: "medium",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Compreensão da proposta, tema e repertório pertinente.",
    },
    {
      title: "Competência 3",
      priority: "medium",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Seleção, organização e defesa dos argumentos.",
    },
    {
      title: "Competência 4",
      priority: "medium",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Coesão, conectivos e progressão textual.",
    },
    {
      title: "Competência 5",
      priority: "medium",
      ...
      importance: 4,
      frequency: "Alta",
      description: "Solução proposta com respeito aos direitos humanos.",
    },
    {
      title: "Estrutura ENEM",
      priority: "hot",
      difficulty: "Fácil",
      importance: 5,
      frequency: "Alta",
      description: "Modelo de 4 a 7 parágrafos com função estratégica.",
    },
    {
      title: "Modelos de introdução",
      priority: "frequent",
      difficulty: "Fácil",
      importance: 4,
      frequency: "Alta",
      description: "Estruturas prontas para começar rápido e com segurança.",
    },
    {
      title: "Modelos de conclusão",
      priority: "frequent",
      difficulty: "Fácil",
      importance: 4,
      frequency: "Alta",
      description: "Fechamentos consistentes com proposta de intervenção.",
    },
    {
      title: "Temas atuais",
      priority: "hot",
      ...
      importance: 5,
      frequency: "Alta",
      description: "Assuntos contemporâneos para treinar repertório e tese.",
    },
    {
      title: "Repertórios por tema",
      priority: "frequent",
      difficulty: "Média",
      importance: 4,
      frequency: "Alta",
      description: "Banco de referências organizado por assunto recorrente.",
    },
    {
      title: "Prática semanal",
      priority: "hot",
      difficulty: "Média",
      importance: 5,
      frequency: "Alta",
      description: "Treino constante para manter produção e correção em alta.",
    },
  ],
};
...
function getWeeklyFlashcardSources(
  state = {},
  scheduleData = buildAdaptiveSchedule(state.settings || {}),
) {
  ...
  const weekStudyItems = (currentWeek?.days || [])
    ...
    .filter(Boolean);
  const completedItems = weekStudyItems.filter(
...
export function buildSchedule() {
    ...
    const days = [
      ...
      },
      {
        ...
        title:
          weekIndex % 2 === 0
            ? "Simulado completo"
            : "Descanso ou revisão livre",
        description:
          weekIndex % 2 === 0
            ? "Treino cronometrado da semana."
            : "Uso livre para revisão leve e descanso mental.",
        contentId: null,
      },
    ];
    ...
    Object.keys(topics).forEach((subject) => {
      items.push(
        createContentItem(
          ...
          topics[subject],
          weekNumber,
          days.find((day) => day.subject === subject)?.date ||
            toISODate(weekStart),
        ),
      );
    });
  ...
  Object.entries(curriculum).forEach(([subject, topics]) => {
    topics.forEach((topic, index) => {
      ...
      items.push(
        createContentItem(subject, index, topic, weekNumber, scheduleStart),
      );
    });
  });
...
export function buildFlashcardDeck(
  ...
  const studiedItems = (
    getWeeklyFlashcardSources(state, scheduleData).length > 0
      ? getWeeklyFlashcardSources(state, scheduleData)
      : getContentItems(scheduleData).filter(
          (item) => getContentStatus(state, item.id) === "done",
        )
  ).sort((a, b) => {
...
function normalizeReviewDays(reviewDays = [], studyDays = []) {
  const filtered = reviewDays.filter(
    (day) => weekdayOrder.includes(day) && !studyDays.includes(day),
  );
...
function buildBalancedTopicQueue() {
  ...
  const subjectBuckets = Object.fromEntries(
    subjectOrder.map((subject) => [
      subject,
      curriculum[subject].map((topic, index) => ({ ...topic, subject, index })),
    ]),
  );
  const queue = [];
  let cursor = 0;
...
export function buildAdaptiveSchedule(settings = {}) {
  ...
  const studyMinutes = Number(
    settings.studyHoursPerDay || settings.studyMinutes || 90,
  );
  ...
  const topicsPerSession = calculateTopicsPerSession(
    topicQueue.length,
    totalStudyDays,
    studyMinutes,
  );
  ...
  for (let dayIndex = 0; dayIndex < totalDays; dayIndex += 1) {
    ...
    const weekBucket = weeks[weekNumber - 1] || {
      weekNumber,
      start: toISODate(addDays(start, (weekNumber - 1) * 7)),
      days: [],
    };
    ...
    if (isReviewDay) {
      dayEntry = {
        ...
        description:
          "Flashcards, resumos e exercícios de revisão sem conteúdo novo.",
        contentId: null,
        blocks: ["Flashcards", "Resumo", "Exercícios"],
      };
    } else if (isStudyDay && queueIndex < topicQueue.length) {
      const assignedTopics = topicQueue.slice(
        queueIndex,
        queueIndex + topicsPerSession,
      );
      ...
      dayEntry = {
        ...
        assignedContentIds: assignedTopics.map(
          (topic) => `${topic.subject}-${topic.index + 1}`,
        ),
