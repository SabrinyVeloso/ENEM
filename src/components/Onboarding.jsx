  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center p-4">
      ...
      <GlassCard className="relative max-w-xl p-6">
        <SectionHeader
          eyebrow="Boas-vindas"
          title="Vamos personalizar seu plano de estudos"
          subtitle="Responda rápido para que o app crie um cronograma inteligente para você."
        />
        ...
        <div className="mt-4">
          ...
          {step === 1 && (
            <div className="grid gap-3">
              <p className="text-sm text-[var(--muted)]">
                Quais dias da semana você pretende estudar?
              </p>
              ...
              <p className="text-sm text-[var(--muted)]">
                Quais dias serão exclusivos para revisão?
              </p>
              <div className="flex gap-2 flex-wrap">
                {[
                  ["sun", "Dom"],
          ...
          {step === 2 && (
            <div className="grid gap-3">
              ...
              <ul className="text-sm">
                ...
                <li>
                  ...
                  {studyTimeOptions.find(
                    (option) => option.value === hoursPerDay,
                  )?.label || `${hoursPerDay} minutos`}
                </li>
                <li>
                  Dias escolhidos:{" "}
                  {studyDays
              ...
              <p className="text-sm text-[var(--muted)]">
                Ao confirmar, seu cronograma será gerado automaticamente e você
                será levado ao painel.
              </p>
            </div>
          )}
        </div>
